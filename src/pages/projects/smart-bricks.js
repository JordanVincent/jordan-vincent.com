  ...
  return (
    ...
    >
      <Paragraph>
        ...
        and meeting up during large events all over the world. Some of them have
        a real talent in building with LEGO bricks. Their creations are admired
        by their fans. And that's how I created Smart Bricks!
      </Paragraph>
      ...
      <Paragraph>
        ...
        share and sell their creation to the community. Fans could buy sets and
        build replicas, like any official LEGO sets. In order to recruit
        artists, I didn't require any extra work from the creator. All they had
        to do is license their model, and I would replicate it, create building
        instruction, buy the necessary bricks, package everything, and sell the
        sets on my website!
      </Paragraph>
      ...
      <Paragraph>
        I reached out to artists in order to license and sell their creations. I
        signed an agreement with the Spanish artist Ricardo Valero, widely known
        as Valgarise. His work is astonishing, look for yourself:
      </Paragraph>

      <Figure src={houseImage} alt="Smart Bricks' Magic House" />

      <Paragraph>
        We decided to start with one of its best creation: The Magic House. This
        model is a beautiful 2,000 pieces Victorian house, home of an intriguing
        magician. When peeking through the windows the visitor can see a strange
        magic shop filled with secrets.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        ...
        the initial idea, all the way to an actual product ready to be shipped!
        I created the 3D model using the 3D software Blender. After creating
        each individual LEGO brick, I built a digital model step by step to
      ...
      <Paragraph>
        ...
        to follow. Then, I ordered all the LEGO parts needed to build the first
        10 models. Meaning, I bought nearly 20,000 pieces! After I received all
        the pieces that I ordered around the world (some pieces where very hard
        to get), I packaged everything, setup the online store, and waited. And
        waited... The irony is that I never sold any set!
      </Paragraph>
      ...
      <Paragraph>
        ...
        do everything differently. First, reaching out to potential customers to
        validate the idea and the market size; and second, use a lean approach
        to reduce risks by starting with a small product, as a proof of concept.
      </Paragraph>
    </Article>
  );
}
