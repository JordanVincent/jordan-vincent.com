...
export default function SmartBricks() {
  return (
    ...
    >
      ...
      <List>
        <li>
          The graph is composed of namespaces. Nodes within namespaces have lots
          of connections. There are very few connections between namespaces,
          except to the Roam layer.
        </li>
        <li>
        ...
        <li>
          The number of connections to a given node is low, generally 1&ndash;3.
        </li>
      </List>
      <Paragraph>
