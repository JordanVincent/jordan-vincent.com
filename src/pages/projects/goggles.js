    ...
    <React.Fragment>
      ...
      <section className="project__container">
        <Paragraph>
          ...
          called Goggles. The tool allows the team to inspect the Roam's
          Knowledge Graph &mdash; a large graph that contains all of Roam's
          health data. Nodes can be drugs, diseases, providers, etc. Edges
          connect nodes together. For instance the "Treats" edge connects a drug
          to a disease.
        </Paragraph>
        <Paragraph>
          ...
          generated a different layout. It hindered the user experience to a
          point where it was not usable anymore.
        </Paragraph>
        ...
        <Paragraph>
          ...
          not, stakeholders and users already have formed an idea on how to
          solve the issue. There's generally more than one solution to a
          problem, and the obvious one is not always the best one. So, I try not
          to listen to solutions and instead focus on the user's current
        ...
        <Paragraph>
          ...
          beginning of a project, I spend a non-trivial amount of time digging
          in the data to understand its shape, size, bias, and quality.
        </Paragraph>

        <Paragraph>Main use-cases:</Paragraph>
        <ul>
          <li>
        ...
        <Paragraph>Main finding on the data side:</Paragraph>
        <ul>
          <li>
        ...
        <Paragraph>
          Pen and paper is the best way to get started, generate, and refine
          dozen of possible ideas. The finding about the data, especially that
          the graph is composed of loosely connected namespaces was critical.
          These constraints help design an ideal solution that answers a
          specific problem.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          ...
          implement it. For data-dependent projects like this one, prototyping
          is an indispensable step in my design process. During the prototyping
        ...
        <Paragraph>
          ...
          solutions. It took 8 prototypes and countless of sketches to arrive at
          a solution that felt right and worked well with the data.
        </Paragraph>
        ...
        <Paragraph>
          With graph layouts, there's always a balance between enforcing
          structure (using predefined rules) and letting some physics or
          generative algorithm create a more organic layout. YOn one hand, you
          have 100% control with structured layouts. They allow you to exactly
          define how things look, improving readability, consistency, and
          hierarchy. But these layouts require a lot of scientific and
          engineering work. On the other hand, one could use some physics
          simulation algorithm to generate a satisfying layout. It's less labor
          intensive, but the result can be approximative.
        </Paragraph>
        <Paragraph>
          I went with an intermediate approach. I needed to control the position
          of the nodes within the namespaces. It's very important at the
          namespace level to show which nodes are connected to which nodes, and
          to do so in a consistent manner. Thus, I had to manually specify how
          to lay out nodes. However, the connections between namespaces are
          sparse and act more as a navigation element. Here, I was able to use
          physics simulation. It gave the visualization an organic look and it
          had the extra benefit of making animations easy to implement.
        </Paragraph>

        <SectionHeading title="Result" />

        <Paragraph>
          The mix of structured namespaces and organic physics simulation was
          the a-ha moment of this project. See for yourself:
        </Paragraph>
        ...
        <Paragraph>
          ...
          highly influenced by the research findings. Additionally, a
          "specimens" page lists all available namespaces to complement the
        ...
        <Paragraph>
          This project was incredibly challenging. It took weeks to come up with
          a concept that made sense to the users and worked with the data. But
          I'm very satisfied with the result. It looks like nothing out there!
        </Paragraph>
